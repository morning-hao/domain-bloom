...
def train(args):
    ...
    logger.info("per_device_train_batch_size = {}, gradient_accumulation_steps = {}".format(
    ...
    logger.info(
        "num_gpus = {}, training_nums = {}, t_total = {}, warmup_steps = {}".format(num_gpus, training_nums, t_total,
                                                                                    warmup_steps))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_on_inputs", action="store_true",
                        help="Target loss only. If False, masks out inputs in loss")
    parser.add_argument("--lora_hyperparams_file", default="./run_config/lora_hyperparams_llama.json", type=str,
